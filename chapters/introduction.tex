...
\begin{figure}
  ...
  \end{subfigure}%
  \caption[Shorten title for the list of figures]{Two figures side-by-side. (a) A triangulation of 2 polygons. (b) Something not related at all.}
...
\subsection{Figures in PDF are possible}
...
\citet{Descartes37} wrote and another one too~\citep{Voronoi08}.
