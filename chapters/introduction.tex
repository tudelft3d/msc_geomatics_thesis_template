...
Instead of citing the whole paper~\citep{Delaunay34}, it is also possible to cite only the authors (\eg\ \citeauthor{Aurenhammer12}).

When adding references to your Bib\TeX file, it is good pratice to add the DOI of the paper.
...
Notice that if you use the field \texttt{doi} you shouldn't append \texttt{http://doi.org/}. 
